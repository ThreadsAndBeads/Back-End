...
const sendVerificationEmail = async (name, email, userId) => {
  try {
    ...
    const mailOptions = {
      ...
      <p style="margin-bottom: 16px;"><a href="https://threadsbeads.onrender.com/api/v1/users/verify?token=${verificationToken}" style="text-decoration:none; color:#008CBA; font-weight:bold;">Verify your email</a></p>
