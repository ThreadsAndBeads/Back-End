...
const sendVerificationEmail = async (name, email, userId) => {
  try {
    ...
    const mailOptions = {
      ...
      <p style="margin-bottom: 16px;"><a href="https://threadsandbeads-4863e.web.app/api/v1/users/verify?token=${verificationToken}" style="text-decoration:none; color:#008CBA; font-weight:bold;">Verify your email</a></p>
